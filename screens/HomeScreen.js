...
function HomeScreen() {
  ...
  useLayoutEffect(() => {
    navigation.setOptions({
      ...
      headerRight: () => (
        <Pressable style={{ paddingRight: 6 }} onPress={handleLogout}>
        ...
        <Box style={styles.container}>
          ...
          >
            ...
            >
              ...
              >
                <Icon
                  as={<Ionicons name={"people-circle-sharp"} />}
                  size={6}
                  color="warmGray.50"
                />
              </Pressable>
